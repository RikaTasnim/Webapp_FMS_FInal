...
$farmer_count = $result_farmers_count ? ($result_farmers_count->fetch_assoc()['farmers_count'] ?? 0) : 0;
$buyer_count  = $result_buyers_count  ? ($result_buyers_count->fetch_assoc()['buyers_count'] ?? 0)   : 0;
$seller_count = $result_sellers_count ? ($result_sellers_count->fetch_assoc()['sellers_count'] ?? 0) : 0;

// Delete feedback by submission_date
...
// Farmers list (for edit modal/section if needed)
    ...
    <main class="dashboard">
        <section id="user-management">
            <div class="card">
                ...
                <button onclick="location.href='farmers_table.php'">View All Farmers (<?php echo (int)$farmer_count; ?>)</button>
                <button onclick="location.href='wholesalers_table.php'">View All Wholesalers (<?php echo (int)$buyer_count; ?>)</button>
                <button onclick="location.href='suppliers_table.php'">View All Suppliers (<?php echo (int)$seller_count; ?>)</button>
            </div>
        </section>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="">
                                            <input type="hidden" name="submission_date" value="<?php echo htmlspecialchars($row['submission_date']); ?>">
