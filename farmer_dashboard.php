    ...
    <main class="dashboard">
        ...
        <section class="farmer-overview">
            ...
            <div class="farmer-card">
                ...
                <p><strong>Farm Type:</strong> <?php echo htmlspecialchars($user['farm_type']); ?></p>
                <p><strong>Location:</strong> <?php echo htmlspecialchars($user['location']); ?></p>
                <p><strong>Land Size:</strong> <?php echo htmlspecialchars($user['land_size']); ?></p>
                <p><strong>Crops Grown:</strong> <?php echo htmlspecialchars($user['crops_grown']); ?></p>
                <p><strong>Livestock:</strong> <?php echo htmlspecialchars($user['livestock']); ?></p>
            </div>
        </section>
