...
// List feedback (join on farmer email)
...
<head>
    ...
    <title>Admin Dashboard - Feedback (FMS)</title>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="">
                                            ...
                                            <button type="submit" name="delete_feedback" class="btn btn-success" onclick="return confirm('Are you sure you want to delete this feedback?');">
                                                Clear
                                            </button>
                                        </form>
                                    </td>
