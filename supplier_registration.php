...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert the supplier data into the database (table name unchanged for now)
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Supplier registration successful!');</script>";
...
<head>
    ...
    <title>Supplier Registration - FMS</title>
    ...
    <main>
        ...
        <section class="registration-form">
            ...
            <form method="POST" action="">
                <label for="seller-name">Supplier Name:</label>
